...
if(NOT PRISM_WASM AND NOT TARGET CLI11::CLI11)
    prism_download_cli11()
    add_subdirectory(${PRISM_EXTERNAL}/cli11)
endif()

if(NOT PRISM_WASM AND NOT TARGET highfive)
  prism_download_HighFive()
  option(HIGHFIVE_USE_EIGEN ON)
  find_package(HDF5 REQUIRED)
  add_library(highfive INTERFACE)
  target_include_directories(highfive SYSTEM INTERFACE ${PRISM_EXTERNAL}/HighFive/include/ ${HDF5_INCLUDE_DIRS} /usr/lib/x86_64-linux-gnu/openmpi/include)
  target_link_libraries(highfive INTERFACE ${HDF5_LIBRARIES})
endif()

if(NOT PRISM_WASM AND NOT TARGET geogram::geogram)
  set_property(GLOBAL PROPERTY ALLOW_DUPLICATE_CUSTOM_TARGETS 1) # geogram conflicts with embree
  prism_download_geogram()
  include(geogram)
endif()

if (NOT PRISM_WASM AND NOT TARGET tbb::tbb)
  prism_download_tbb()
  add_subdirectory(${PRISM_EXTERNAL}/tbb)
endif()

if (NOT PRISM_WASM AND NOT TARGET cvc3_rational)
...
if (NOT TARGET osqp)
  ...
  if(PRISM_WASM AND NOT TARGET osqp)
    add_library(osqp ALIAS osqpstatic)
  endif()
endif()
